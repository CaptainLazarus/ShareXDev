...
public class receiveFile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField3.setToolTipText("Enter Desired Port");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Server fs = new Server(Integer.parseInt(jTextField3.getText()));
        jButton1.setEnabled(false);
        fs.start();
        }
        catch(Exception e){
            jTextField3.setEditable(true);
            JOptionPane.showMessageDialog(null , "Check your Port");
        }        
